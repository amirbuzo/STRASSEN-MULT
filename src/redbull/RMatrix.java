/*
 * File: RMatrix.java Author: Jonas Lundberg Date: 12 feb 2010
 */
package redbull;

/**
 * A two dimensional <em>square</em> matrix interface where each element is a ring member. Notice,
 * each matrix (of size NxN) is in itself an element of a ring over all NxN-matrices.
 * <p/>
 * 
 * 
 ...
 * <p/>
 * 
 * Methods that are returning matrices (e.g. getCopy(), mult() ) should return matrices that are
 * independent of the input matrices. That is, they should not share any interior parts (except
 * possibly the entries) and further updates of the input matrices should not affect the result
